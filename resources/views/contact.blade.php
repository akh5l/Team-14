...
<div class="flex-grow flex justify-center items-center py-12">
    <div class="flex gap-12 items-center">
        ...
        <div class="w-full max-w-xl bg-[#2c2f66] shadow-2xl rounded-2xl p-8 text-white">
            ...
            <h2 class="text-3xl font-bold mb-2 text-white">Contact Us</h2>
            <p class="text-gray-300 mb-6 text-sm">
                We aim to respond promptly to all enquiries. Watch out for an email!
            </p>

            <!-- Contact information -->
            <div class="mb-8 text-gray-200 text-sm space-y-2">
            ...
            @if(request()->has('success'))
                <div class="mb-4 bg-[#85c061]/20 text-[#85c061] text-sm px-4 py-2 rounded">
            ...
            <form action="https://api.web3forms.com/submit" method="POST" class="space-y-5">
                ...
                <input class="w-full bg-[#292755] border border-[#6163b3] text-white rounded-lg px-4 py-2 focus:ring-2 focus:ring-[#6163b3] focus:outline-none"
                    type="text"
                    name="name"
                ...
                <button
                    type="submit"
                    class="w-full bg-[#6163b3] hover:bg-[#4c4fa3] text-white font-semibold px-4 py-2 rounded-lg hover:bg-blue-800 transition"
                >
                    Send Message
                </button>
            </form>
