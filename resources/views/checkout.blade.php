...
@section('content')
    ...
    <main class="max-w-6xl mx-auto px-4 py-12 flex-grow">
        <!-- example and insp from this website https://www.convertcart.com/blog/checkout-page-examples-->
        ...
        <div class="md:grid md:grid-cols-3 gap-10">
                ...
                <form id ="checkoutForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id ="cardNumber"
                                 ...
                                 class="w-full border border-gray-300 rounded-lg px-4 py-2 tracking-widest focus:ring-blue-500 focus:outline-none">
                    </div>
            ...
            <div>
                ...
                <input id="cardName"
                        ...
                        class= "w-full border border-gray-300 rounded-lg px-4 py-2 focus:rind-blue-500 focus:outline-none">
            </div>
    ...
    <div class ="md:grid md:cols-span-3 gap-10">
        <div class="bg-white p-6 rounded-lg shadow border border-gray-100 h-fit">
            <h2 class="text-xl font-semibold mb-4">Order Summary</h2>
        
        <div class="flex items-center gap-4 mb-4">
            <img src ="/images/products/d&d.png"
                class="w-20 h-20 rounded object-contains bg-gray-100" alt="D&D Dragons of Stormwreck Isle">
            <div class="flex-1">
...
//ALL CARD VALIDATIONS:
    ...
    const check = new Date(expiry + "-01T00:00:00");
    if (check <= today) { //has to be future - to make sure usable card
        errorBox.textContent = "This card has expired!";
        errorBox.classList.remove("hidden");
        return;
    }
