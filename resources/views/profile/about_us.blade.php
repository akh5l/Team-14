@extends('layouts.app')
@section('content')
    <section class="relative h-96 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div class="backdrop-blur-xl bg-black/50 rounded-full px-20 py-5">
            ...
            <p class="mb-6 text-lg md:text-xl drop-shadow-lg">Unity before division. Courage before doubt. Connection before conquest</p>
        </div>
    </section>

    <section class="max-w-7xl mx-auto px-4 py-12 bg-gradient-to-r from-gray-50 via-gray-100 to-gray-50 rounded-lg shadow-lg">
    ...
    <div class="prose mx-auto text-center text-gray-700 max-w-3xl">
        <p class="mb-4">
            Founded in 2025, Bridge 14 Games started as a small local shop in Birmingham dedicated to providing high-quality tabletop and video games to casual gamers and hobbyists alike. Over the years, we've grown into a vibrant hub for gamers of all ages, offering everything from board games, card games and wargames to video games of every genre.
        </p>
        <p class="mb-4">
            Our name is derived from the 'Bridge 4' team from Brandon Sanderson's epic fantasy series, <em>The Stormlight Archive</em>. Like Kaladin and his team, we aim to build strength through unity and unwavering camaraderie: just as they forge bonds through adversity, we strive to forge bonds through tabletop and video games; bridging connections all along the way.
        </p>
        <p class="mb-4">
            At Bridge 14 Games, our mission is to create a welcoming space where gamers can connect, learn, and grow together. Whether you're new to gaming or a seasoned veteran, our community is built on shared passion, resilience, and mutual support. We believe that games are more than just entertainment—they're a way to build friendships, develop skills, and create lasting memories.
        </p>
        <p class="mb-8">
            Join us as we continue to grow and bridge communities through the power of play.
        </p>
        <p class="text-center text-2xl md:text-3xl font-bold text-gray-800 mt-8 drop-shadow-lg">Together, we're stronger.</p>
    </div>
</section>
...
<section class="py-12 bg-white-100">
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            @foreach([
                ['quote'=>'Bridge 14 Games is my second home. The community is welcoming, and the staff always go above and beyond!', 'name'=>'John Doe'],
                ['quote'=>'I couldn\'t recommend this place enough! It is the perfect place to find fellow enthusiasts.', 'name'=>'Jane Doe']] as $testimonial)
            <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 duration-300">
